...
#define TRANSLATE_ALL_FILES while(argc > 1){
...
/*------------------*//*Errors enums*/
enum errors{
    illegal_sym = 101, sym_defined_already, sym_is_key, brack_err, string_err, undef_parameter,
    writing_to_file, undef_symbol, float_err, immediate_wrong_use, not_enough_params,
    file_op_err, err_app_file, src_meth0_illegal, src_meth1_illegal, src_meth2_illegal,
    src_meth3_illegal, symbol_is_ent_and_ext, data_line_with_no_data, no_definer_in_line,
    dst_meth0_illegal, dst_meth1_illegal, dst_meth2_illegal, dst_meth3_illegal, missing_comma,
    comm_mis_match, extra_commas, undef_char, extra_ent, uns_ex_sym, redu_info, illegal_sym_mth,
    bef_ext, sym_miss_place, order_error, invalid_input, missing_second_param, missing_first_param,
    missing_both_params,chars_before_comment, missing_sym, illegal_operand
